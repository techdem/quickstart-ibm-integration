//TODO We cannot use any marketing text (e.g. market-leading), and verbatim text from other public web pages - please paraphrase, and possibly shorten this section.
