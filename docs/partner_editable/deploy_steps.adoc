...
Also, make sure that the domain name option in the DHCP options is configured as explained in the http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_DHCP_Options.html[DHCP options sets^] topic in the Amazon VPC documentation. You provide your VPC settings when you launch the Quick Start.
